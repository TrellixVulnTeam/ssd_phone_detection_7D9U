...
class LoadImagesAndLabels(Dataset):  # for training/testing
    def __init__(self, path='/home/disk/tanjing/projects/adas_multitask/vista/', img_size=512, batch_size=16, augment=False, hyp=None, rect=False, image_weights=False,
