...
class phone_128_float(nn.Module):
    def __init__(self):
        super(phone_128_float, self).__init__()
        ...
        # self.conv8_1=nn.Conv2d(256, 512, kernel_size=(1, 1), padding=(0, 0), stride=(1, 1), groups=1, dilation=1, bias=True)
