...
class phone_128_vgg_float(nn.Module):
    def __init__(self):
        ...
        self.conv2_1=nn.Conv2d(64, 64, kernel_size=(3, 3), padding=(1, 1), stride=(1, 1), groups=1, dilation=1, bias=True)
        self.bn_conv2_1=nn.BatchNorm2d(num_features=64)
        self.relu2_1=nn.ReLU(inplace=True)
        self.conv2_2=nn.Conv2d(64, 128, kernel_size=(3, 3), padding=(1, 1), stride=(1, 1), groups=1, dilation=1, bias=True)
        self.bn_conv2_2=nn.BatchNorm2d(num_features=128)
        self.relu2_2=nn.ReLU(inplace=True)
        self.pool2=nn.MaxPool2d(kernel_size=2, stride=2)
        self.conv3_1=nn.Conv2d(128, 128, kernel_size=(3, 3), padding=(1, 1), stride=(1, 1), groups=1, dilation=1, bias=True)
        self.bn_conv3_1=nn.BatchNorm2d(num_features=128)
        self.relu3_1=nn.ReLU(inplace=True)
        self.conv3_2=nn.Conv2d(128, 128, kernel_size=(3, 3), padding=(1, 1), stride=(1, 1), groups=1, dilation=1, bias=True)
        self.bn_conv3_2=nn.BatchNorm2d(num_features=128)
        self.relu3_2=nn.ReLU(inplace=True)
        self.pool3=nn.MaxPool2d(kernel_size=2, stride=2)
        self.conv4_1=nn.Conv2d(128, 256, kernel_size=(3, 3), padding=(1, 1), stride=(1, 1), groups=1, dilation=1, bias=True)
        self.bn_conv4_1=nn.BatchNorm2d(num_features=256)
        self.relu4_1=nn.ReLU(inplace=True)
        self.conv4_2=nn.Conv2d(256, 256, kernel_size=(3, 3), padding=(1, 1), stride=(1, 1), groups=1, dilation=1, bias=True)
        self.bn_conv4_2=nn.BatchNorm2d(num_features=256)
        self.relu4_2=nn.ReLU(inplace=True)
        self.pool4=nn.MaxPool2d(kernel_size=2, stride=2)
        self.conv5_1=nn.Conv2d(256, 512, kernel_size=(3, 3), padding=(1, 1), stride=(1, 1), groups=1, dilation=1, bias=True)
        ...
        self.conv5_3=nn.Conv2d(512, 256, kernel_size=(3, 3), padding=(1, 1), stride=(1, 1), groups=1, dilation=1, bias=True)
        self.bn_conv5_3=nn.BatchNorm2d(num_features=256)
        self.relu5_3=nn.ReLU(inplace=True)
        self.fc7=nn.Conv2d(256, 256, kernel_size=(1, 1), padding=(0, 0), stride=(1, 1), groups=1, dilation=1, bias=True)
        ...
        self.conv6_2=nn.Conv2d(128, 128, kernel_size=(3, 3), padding=(1, 1), stride=(2, 2), groups=1, dilation=1, bias=True)
        self.bn_conv6_2=nn.BatchNorm2d(num_features=128)
        self.conv6_2_relu=nn.ReLU(inplace=True)
        self.conv7_1=nn.Conv2d(128, 128, kernel_size=(1, 1), padding=(0, 0), stride=(1, 1), groups=1, dilation=1, bias=True)
        ...
        self.conv4_3_norm_mbox_loc=nn.Conv2d(256, 24, kernel_size=(3, 3), padding=(1, 1), stride=(1, 1), groups=1, dilation=1, bias=True)
        self.conv4_3_norm_mbox_loc_perm=custom_nn.Permute(order=[0, 2, 3, 1])
        self.conv4_3_norm_mbox_loc_flat=custom_nn.Flatten()
        self.conv4_3_norm_mbox_conf=nn.Conv2d(256, 12, kernel_size=(3, 3), padding=(1, 1), stride=(1, 1), groups=1, dilation=1, bias=True)
