...
class phone_128_vgg_float(nn.Module):
    def __init__(self):
        ...
        # self.conv4_1=nn.Conv2d(512, 512, kernel_size=(3, 3), padding=(1, 1), stride=(1, 1), groups=1, dilation=1, bias=True)
        ...
        # self.fc7=nn.Conv2d(512, 512, kernel_size=(3, 3), padding=(0, 0), stride=(1, 1), groups=1, dilation=1, bias=True)
        ...
        self.fc7_mbox_loc=nn.Conv2d(512, 24, kernel_size=(3, 3), padding=(1, 1), stride=(1, 1), groups=1, dilation=1, bias=True)
        self.fc7_mbox_loc_perm=custom_nn.Permute(order=[0, 2, 3, 1])
        self.fc7_mbox_loc_flat=custom_nn.Flatten()
        self.fc7_mbox_conf=nn.Conv2d(512, 12, kernel_size=(3, 3), padding=(1, 1), stride=(1, 1), groups=1, dilation=1, bias=True)
        self.fc7_mbox_conf_perm=custom_nn.Permute(order=[0, 2, 3, 1])
        self.fc7_mbox_conf_flat=custom_nn.Flatten()
        self.conv6_2_mbox_loc=nn.Conv2d(512, 24, kernel_size=(3, 3), padding=(1, 1), stride=(1, 1), groups=1, dilation=1, bias=True)
        self.conv6_2_mbox_loc_perm=custom_nn.Permute(order=[0, 2, 3, 1])
        self.conv6_2_mbox_loc_flat=custom_nn.Flatten()
        self.conv6_2_mbox_conf=nn.Conv2d(512, 12, kernel_size=(3, 3), padding=(1, 1), stride=(1, 1), groups=1, dilation=1, bias=True)
        self.conv6_2_mbox_conf_perm=custom_nn.Permute(order=[0, 2, 3, 1])
        self.conv6_2_mbox_conf_flat=custom_nn.Flatten()
        self.conv7_2_mbox_loc=nn.Conv2d(256, 24, kernel_size=(3, 3), padding=(1, 1), stride=(1, 1), groups=1, dilation=1, bias=True)
        self.conv7_2_mbox_loc_perm=custom_nn.Permute(order=[0, 2, 3, 1])
        self.conv7_2_mbox_loc_flat=custom_nn.Flatten()
        self.conv7_2_mbox_conf=nn.Conv2d(256, 12, kernel_size=(3, 3), padding=(1, 1), stride=(1, 1), groups=1, dilation=1, bias=True)
        self.conv7_2_mbox_conf_perm=custom_nn.Permute(order=[0, 2, 3, 1])
        self.conv7_2_mbox_conf_flat=custom_nn.Flatten()
        self.conv8_2_mbox_loc=nn.Conv2d(256, 24, kernel_size=(3, 3), padding=(1, 1), stride=(1, 1), groups=1, dilation=1, bias=True)
        self.conv8_2_mbox_loc_perm=custom_nn.Permute(order=[0, 2, 3, 1])
        self.conv8_2_mbox_loc_flat=custom_nn.Flatten()
        self.conv8_2_mbox_conf=nn.Conv2d(256, 12, kernel_size=(3, 3), padding=(1, 1), stride=(1, 1), groups=1, dilation=1, bias=True)
...
#     torch.save(state_dict,'caffe_models/vgg/phone_128_vgg_float.pth')